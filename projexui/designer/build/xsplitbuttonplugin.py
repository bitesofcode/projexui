...
from projexui.widgets.xsplitbutton import XSplitButton as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XSplitButton">
  <widget class="XSplitButton" name="XSplitButton"/>
  <customwidgets>
    <customwidget>
      <class>XSplitButton</class>
      <header>projexui.widgets.xsplitbutton</header>
...
class XSplitButtonPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XSplitButtonPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xsplitbutton'
