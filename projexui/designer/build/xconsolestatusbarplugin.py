...
DEFAULT_XML = '''<ui language="c++" displayname="XConsoleStatusBar">
  <widget class="XConsoleStatusBar" name="XConsoleStatusBar"/>
  <customwidgets>
    <customwidget>
      <class>XConsoleStatusBar</class>
      <header>projexui.widgets.xconsolestatusbar</header>
