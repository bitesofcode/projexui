...
from projexui.widgets.xserialedit import XSerialEdit as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XSerialEdit">
  <widget class="XSerialEdit" name="XSerialEdit"/>
  <customwidgets>
    <customwidget>
      <class>XSerialEdit</class>
      <header>projexui.widgets.xserialedit</header>
...
class XSerialEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XSerialEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xserialedit'
