...
from projexui.widgets.xorbgridedit import XOrbGridEdit as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XOrbGridEdit">
  <widget class="XOrbGridEdit" name="XOrbGridEdit"/>
  <customwidgets>
    <customwidget>
      <class>XOrbGridEdit</class>
      <header>projexui.widgets.xorbgridedit</header>
...
class XOrbGridEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XOrbGridEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xorbgridedit'
