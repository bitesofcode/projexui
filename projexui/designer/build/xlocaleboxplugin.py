...
from projexui.widgets.xlocalebox import XLocaleBox as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XLocaleBox">
  <widget class="XLocaleBox" name="XLocaleBox"/>
  <customwidgets>
    <customwidget>
      <class>XLocaleBox</class>
      <header>projexui.widgets.xlocalebox</header>
...
class XLocaleBoxPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XLocaleBoxPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xlocalebox'
