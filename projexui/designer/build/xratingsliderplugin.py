...
DEFAULT_XML = '''<ui language="c++" displayname="XRatingSlider">
  <widget class="XRatingSlider" name="XRatingSlider"/>
  <customwidgets>
    <customwidget>
      <class>XRatingSlider</class>
      <header>projexui.widgets.xratingslider</header>
