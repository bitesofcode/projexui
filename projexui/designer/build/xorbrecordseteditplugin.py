...
DEFAULT_XML = '''<ui language="c++" displayname="XOrbRecordSetEdit">
  <widget class="XOrbRecordSetEdit" name="XOrbRecordSetEdit"/>
  <customwidgets>
    <customwidget>
      <class>XOrbRecordSetEdit</class>
      <header>projexui.widgets.xorbrecordsetedit</header>
