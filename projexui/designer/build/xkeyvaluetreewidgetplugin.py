...
from projexui.widgets.xkeyvaluetreewidget import XKeyValueTreeWidget as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XKeyValueTreeWidget">
  <widget class="XKeyValueTreeWidget" name="XKeyValueTreeWidget"/>
  <customwidgets>
    <customwidget>
      <class>XKeyValueTreeWidget</class>
      <header>projexui.widgets.xkeyvaluetreewidget</header>
...
class XKeyValueTreeWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XKeyValueTreeWidgetPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xkeyvaluetreewidget'
