...
from projexui.widgets.xtabwidget import XTabWidget as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XTabWidget">
  <widget class="XTabWidget" name="XTabWidget"/>
  <customwidgets>
    <customwidget>
      <class>XTabWidget</class>
      <header>projexui.widgets.xtabwidget</header>
...
class XTabWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XTabWidgetPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xtabwidget'
