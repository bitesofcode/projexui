...
from projexui.widgets.xsearchedit import XSearchEdit as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XSearchEdit">
  <widget class="XSearchEdit" name="XSearchEdit"/>
  <customwidgets>
    <customwidget>
...
class XSearchEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XSearchEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xsearchedit'
