...
DEFAULT_XML = '''<ui language="c++" displayname="XOrbSchemaBox">
  <widget class="XOrbSchemaBox" name="XOrbSchemaBox"/>
  <customwidgets>
    <customwidget>
      <class>XOrbSchemaBox</class>
      <header>projexui.widgets.xorbschemabox</header>
