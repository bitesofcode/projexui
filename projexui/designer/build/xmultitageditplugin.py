...
DEFAULT_XML = '''<ui language="c++" displayname="XMultiTagEdit">
  <widget class="XMultiTagEdit" name="XMultiTagEdit"/>
  <customwidgets>
    <customwidget>
      <class>XMultiTagEdit</class>
      <header>projexui.widgets.xmultitagedit</header>
