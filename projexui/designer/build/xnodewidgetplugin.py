...
DEFAULT_XML = '''<ui language="c++" displayname="XNodeWidget">
  <widget class="XNodeWidget" name="XNodeWidget"/>
  <customwidgets>
    <customwidget>
      <class>XNodeWidget</class>
      <header>projexui.widgets.xnodewidget</header>
