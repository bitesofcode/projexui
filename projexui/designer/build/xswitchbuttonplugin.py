...
from projexui.widgets.xswitchbutton import XSwitchButton as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XSwitchButton">
  <widget class="XSwitchButton" name="XSwitchButton"/>
  <customwidgets>
    <customwidget>
      <class>XSwitchButton</class>
      <header>projexui.widgets.xswitchbutton</header>
...
class XSwitchButtonPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XSwitchButtonPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xswitchbutton'
