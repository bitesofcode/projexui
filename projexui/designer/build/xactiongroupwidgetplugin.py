...
DEFAULT_XML = '''<ui language="c++" displayname="XActionGroupWidget">
  <widget class="XActionGroupWidget" name="XActionGroupWidget"/>
  <customwidgets>
    <customwidget>
      <class>XActionGroupWidget</class>
      <header>projexui.widgets.xactiongroupwidget</header>
