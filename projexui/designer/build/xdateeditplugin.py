...
from projexui.widgets.xdateedit import XDateEdit as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XDateEdit">
  <widget class="XDateEdit" name="XDateEdit"/>
  <customwidgets>
    <customwidget>
      <class>XDateEdit</class>
      <header>projexui.widgets.xdateedit</header>
...
class XDateEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XDateEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xdateedit'
