...
from projexui.widgets.xprogressfeedbackwidget import XProgressFeedbackWidget as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XProgressFeedbackWidget">
  <widget class="XProgressFeedbackWidget" name="XProgressFeedbackWidget"/>
  <customwidgets>
    <customwidget>
      <class>XProgressFeedbackWidget</class>
      <header>projexui.widgets.xprogressfeedbackwidget</header>
...
class XProgressFeedbackWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XProgressFeedbackWidgetPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xprogressfeedbackwidget'
