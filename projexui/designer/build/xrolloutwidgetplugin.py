...
DEFAULT_XML = '''<ui language="c++" displayname="XRolloutWidget">
  <widget class="XRolloutWidget" name="XRolloutWidget"/>
  <customwidgets>
    <customwidget>
      <class>XRolloutWidget</class>
      <header>projexui.widgets.xrolloutwidget</header>
