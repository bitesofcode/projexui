...
from projexui.widgets.xdatetimeedit import XDateTimeEdit as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XDateTimeEdit">
  <widget class="XDateTimeEdit" name="XDateTimeEdit"/>
  <customwidgets>
    <customwidget>
      <class>XDateTimeEdit</class>
      <header>projexui.widgets.xdatetimeedit</header>
...
class XDateTimeEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XDateTimeEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xdatetimeedit'
