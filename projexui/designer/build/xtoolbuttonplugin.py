...
from projexui.widgets.xtoolbutton import XToolButton as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XToolButton">
  <widget class="XToolButton" name="XToolButton"/>
  <customwidgets>
    <customwidget>
...
class XToolButtonPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XToolButtonPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xtoolbutton'
