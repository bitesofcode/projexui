...
DEFAULT_XML = '''<ui language="c++" displayname="XColorButton">
  <widget class="XColorButton" name="XColorButton"/>
  <customwidgets>
    <customwidget>
      <class>XColorButton</class>
      <header>projexui.widgets.xcolorbutton</header>
