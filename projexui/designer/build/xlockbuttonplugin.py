...
from projexui.widgets.xlockbutton import XLockButton as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XLockButton">
  <widget class="XLockButton" name="XLockButton"/>
  <customwidgets>
    <customwidget>
      <class>XLockButton</class>
      <header>projexui.widgets.xlockbutton</header>
...
class XLockButtonPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XLockButtonPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xlockbutton'
