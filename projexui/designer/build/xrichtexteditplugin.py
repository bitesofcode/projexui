...
DEFAULT_XML = '''<ui language="c++" displayname="XRichTextEdit">
  <widget class="XRichTextEdit" name="XRichTextEdit"/>
  <customwidgets>
    <customwidget>
      <class>XRichTextEdit</class>
      <header>projexui.widgets.xrichtextedit</header>
