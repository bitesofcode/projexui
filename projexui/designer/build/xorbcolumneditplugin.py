...
DEFAULT_XML = '''<ui language="c++" displayname="XOrbColumnEdit">
  <widget class="XOrbColumnEdit" name="XOrbColumnEdit"/>
  <customwidgets>
    <customwidget>
      <class>XOrbColumnEdit</class>
      <header>projexui.widgets.xorbcolumnedit</header>
