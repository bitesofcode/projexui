...
from projexui.widgets.xtextedit import XTextEdit as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XTextEdit">
  <widget class="XTextEdit" name="XTextEdit"/>
  <customwidgets>
    <customwidget>
      <class>XTextEdit</class>
      <header>projexui.widgets.xtextedit</header>
...
class XTextEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XTextEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xtextedit'
