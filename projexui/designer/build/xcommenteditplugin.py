...
from projexui.widgets.xcommentedit import XCommentEdit as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XCommentEdit">
  <widget class="XCommentEdit" name="XCommentEdit"/>
  <customwidgets>
    <customwidget>
      <class>XCommentEdit</class>
      <header>projexui.widgets.xcommentedit</header>
...
class XCommentEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XCommentEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xcommentedit'
