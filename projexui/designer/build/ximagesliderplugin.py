...
from projexui.widgets.ximageslider.ximageslider import XImageSlider as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XImageSlider">
  <widget class="XImageSlider" name="XImageSlider"/>
  <customwidgets>
    <customwidget>
      <class>XImageSlider</class>
      <header>projexui.widgets.ximageslider.ximageslider</header>
...
class XImageSliderPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XImageSliderPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.ximageslider.ximageslider'
