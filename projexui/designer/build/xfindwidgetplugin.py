...
DEFAULT_XML = '''<ui language="c++" displayname="XFindWidget">
  <widget class="XFindWidget" name="XFindWidget"/>
  <customwidgets>
    <customwidget>
      <class>XFindWidget</class>
      <header>projexui.widgets.xfindwidget</header>
