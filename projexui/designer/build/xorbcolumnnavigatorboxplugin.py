...
from projexui.widgets.xorbcolumnnavigator import XOrbColumnNavigatorBox as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XOrbColumnNavigatorBox">
  <widget class="XOrbColumnNavigatorBox" name="XOrbColumnNavigatorBox"/>
  <customwidgets>
    <customwidget>
      <class>XOrbColumnNavigatorBox</class>
      <header>projexui.widgets.xorbcolumnnavigator</header>
...
class XOrbColumnNavigatorBoxPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XOrbColumnNavigatorBoxPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xorbcolumnnavigator'
