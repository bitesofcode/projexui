...
from projexui.widgets.xtimerlabel import XTimerLabel as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XTimerLabel">
  <widget class="XTimerLabel" name="XTimerLabel"/>
  <customwidgets>
    <customwidget>
      <class>XTimerLabel</class>
      <header>projexui.widgets.xtimerlabel</header>
...
class XTimerLabelPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XTimerLabelPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xtimerlabel'
