...
DEFAULT_XML = '''<ui language="c++" displayname="XPagesWidget">
  <widget class="XPagesWidget" name="XPagesWidget"/>
  <customwidgets>
    <customwidget>
      <class>XPagesWidget</class>
      <header>projexui.widgets.xpageswidget</header>
