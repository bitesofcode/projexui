...
from projexui.widgets.xchart import XChart as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XChart">
  <widget class="XChart" name="XChart"/>
  <customwidgets>
    <customwidget>
      <class>XChart</class>
      <header>projexui.widgets.xchart</header>
...
class XChartPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XChartPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xchart'
