...
class XShortcutDialog( QDialog ):
    ...
    @staticmethod
    @deprecatedmethod('XShortcutDialog', 
                      'Use XShortcutConfig with the config system')
    def edit( actions, parent = None ):
        dlg = XShortcutDialog( parent )
