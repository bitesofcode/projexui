...
DEFAULT_XML = '''<ui language="c++" displayname="XLocationWidget">
  <widget class="XLocationWidget" name="XLocationWidget"/>
  <customwidgets>
    <customwidget>
      <class>XLocationWidget</class>
      <header>projexui.widgets.xlocationwidget</header>
