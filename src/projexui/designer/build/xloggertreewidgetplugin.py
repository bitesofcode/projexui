...
from projexui.widgets.xloggerwidget import XLoggerTreeWidget as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XLoggerTreeWidget">
  <widget class="XLoggerTreeWidget" name="XLoggerTreeWidget"/>
  <customwidgets>
    <customwidget>
...
class XLoggerTreeWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XLoggerTreeWidgetPlugin, self).__init__(parent)
