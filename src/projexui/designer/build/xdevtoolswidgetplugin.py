...
from projexui.widgets.xdevtoolswidget import XDevToolsWidget as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XDevToolsWidget">
  <widget class="XDevToolsWidget" name="XDevToolsWidget"/>
  <customwidgets>
    <customwidget>
      <class>XDevToolsWidget</class>
      <header>projexui.widgets.xdevtoolswidget</header>
...
class XDevToolsWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XDevToolsWidgetPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xdevtoolswidget'
