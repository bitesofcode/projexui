...
from projexui.widgets.xorbquerywidget import XOrbQuickFilterWidget as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XOrbQuickFilterWidget">
  <widget class="XOrbQuickFilterWidget" name="XOrbQuickFilterWidget"/>
  <customwidgets>
    <customwidget>
      <class>XOrbQuickFilterWidget</class>
...
class XOrbQuickFilterWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XOrbQuickFilterWidgetPlugin, self).__init__(parent)
