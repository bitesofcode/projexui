...
DEFAULT_XML = '''<ui language="c++" displayname="XOrbBrowserWidget">
  <widget class="XOrbBrowserWidget" name="XOrbBrowserWidget"/>
  <customwidgets>
    <customwidget>
      <class>XOrbBrowserWidget</class>
      <header>projexui.widgets.xorbbrowserwidget</header>
