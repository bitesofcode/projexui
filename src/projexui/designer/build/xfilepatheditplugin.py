...
DEFAULT_XML = '''<ui language="c++" displayname="XFilepathEdit">
  <widget class="XFilepathEdit" name="XFilepathEdit"/>
  <customwidgets>
    <customwidget>
      <class>XFilepathEdit</class>
      <header>projexui.widgets.xfilepathedit</header>
