...
DEFAULT_XML = '''<ui language="c++" displayname="XOrbRecordBox">
  <widget class="XOrbRecordBox" name="XOrbRecordBox"/>
  <customwidgets>
    <customwidget>
      <class>XOrbRecordBox</class>
      <header>projexui.widgets.xorbrecordbox</header>
