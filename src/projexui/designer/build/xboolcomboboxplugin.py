...
from projexui.widgets.xboolcombobox import XBoolComboBox as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XBoolComboBox">
  <widget class="XBoolComboBox" name="XBoolComboBox"/>
  <customwidgets>
    <customwidget>
      <class>XBoolComboBox</class>
      <header>projexui.widgets.xboolcombobox</header>
...
class XBoolComboBoxPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XBoolComboBoxPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xboolcombobox'
