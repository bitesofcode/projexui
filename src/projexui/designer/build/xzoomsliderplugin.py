...
DEFAULT_XML = '''<ui language="c++" displayname="XZoomSlider">
  <widget class="XZoomSlider" name="XZoomSlider"/>
  <customwidgets>
    <customwidget>
      <class>XZoomSlider</class>
      <header>projexui.widgets.xzoomslider</header>
