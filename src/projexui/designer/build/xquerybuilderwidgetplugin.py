...
DEFAULT_XML = '''<ui language="c++" displayname="XQueryBuilderWidget">
  <widget class="XQueryBuilderWidget" name="XQueryBuilderWidget"/>
  <customwidgets>
    <customwidget>
      <class>XQueryBuilderWidget</class>
      <header>projexui.widgets.xquerybuilderwidget</header>
