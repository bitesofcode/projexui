...
from projexui.widgets.xmdiarea import XMdiArea as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XMdiArea">
  <widget class="XMdiArea" name="XMdiArea"/>
  <customwidgets>
    <customwidget>
      <class>XMdiArea</class>
      <header>projexui.widgets.xmdiarea</header>
...
class XMdiAreaPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XMdiAreaPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xmdiarea'
