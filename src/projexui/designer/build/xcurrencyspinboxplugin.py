...
DEFAULT_XML = '''<ui language="c++" displayname="XCurrencySpinBox">
  <widget class="XCurrencySpinBox" name="XCurrencySpinBox"/>
  <customwidgets>
    <customwidget>
      <class>XCurrencySpinBox</class>
      <header>projexui.widgets.xcurrencyspinbox</header>
