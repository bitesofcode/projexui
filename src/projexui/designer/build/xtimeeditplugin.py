...
from projexui.widgets.xtimeedit import XTimeEdit as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XTimeEdit">
  <widget class="XTimeEdit" name="XTimeEdit"/>
  <customwidgets>
    <customwidget>
      <class>XTimeEdit</class>
      <header>projexui.widgets.xtimeedit</header>
...
class XTimeEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XTimeEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xtimeedit'
