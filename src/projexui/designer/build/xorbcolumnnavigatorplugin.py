...
from projexui.widgets.xorbcolumnnavigator import XOrbColumnNavigator as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XOrbColumnNavigator">
  <widget class="XOrbColumnNavigator" name="XOrbColumnNavigator"/>
  <customwidgets>
    <customwidget>
      <class>XOrbColumnNavigator</class>
...
class XOrbColumnNavigatorPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XOrbColumnNavigatorPlugin, self).__init__(parent)
