...
DEFAULT_XML = '''<ui language="c++" displayname="XColorTreeWidget">
  <widget class="XColorTreeWidget" name="XColorTreeWidget"/>
  <customwidgets>
    <customwidget>
      <class>XColorTreeWidget</class>
      <header>projexui.widgets.xcolortreewidget</header>
