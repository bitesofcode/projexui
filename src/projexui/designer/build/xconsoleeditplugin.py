...
DEFAULT_XML = '''<ui language="c++" displayname="XConsoleEdit">
  <widget class="XConsoleEdit" name="XConsoleEdit"/>
  <customwidgets>
    <customwidget>
      <class>XConsoleEdit</class>
      <header>projexui.widgets.xconsoleedit</header>
