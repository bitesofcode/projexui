...
DEFAULT_XML = '''<ui language="c++" displayname="XUrlWidget">
  <widget class="XUrlWidget" name="XUrlWidget"/>
  <customwidgets>
    <customwidget>
      <class>XUrlWidget</class>
      <header>projexui.widgets.xurlwidget</header>
