...
from projexui.widgets.xtimedeltaedit import XTimeDeltaEdit as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XTimeDeltaEdit">
  <widget class="XTimeDeltaEdit" name="XTimeDeltaEdit"/>
  <customwidgets>
    <customwidget>
      <class>XTimeDeltaEdit</class>
      <header>projexui.widgets.xtimedeltaedit</header>
...
class XTimeDeltaEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XTimeDeltaEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xtimedeltaedit'
