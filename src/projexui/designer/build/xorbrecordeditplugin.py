...
DEFAULT_XML = '''<ui language="c++" displayname="XOrbRecordEdit">
  <widget class="XOrbRecordEdit" name="XOrbRecordEdit"/>
  <customwidgets>
    <customwidget>
      <class>XOrbRecordEdit</class>
      <header>projexui.widgets.xorbrecordedit</header>
