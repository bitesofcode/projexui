...
DEFAULT_XML = '''<ui language="c++" displayname="XNavigationEdit">
  <widget class="XNavigationEdit" name="XNavigationEdit"/>
  <customwidgets>
    <customwidget>
      <class>XNavigationEdit</class>
      <header>projexui.widgets.xnavigationedit</header>
